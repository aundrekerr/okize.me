    ...
    <main className={pageStyles.pageContainer}>
      ...
      <div className={`${pageStyles.pageSecond}`}>
        ...
        <div className="w-full block">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium reiciendis suscipit, quam soluta voluptates praesentium tempora dicta architecto dolore aut doloremque vero accusamus, autem corrupti, delectus ab in sequi non!</p>
        </div>
      </div>
    </main>
